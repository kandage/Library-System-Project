...
public class BorrowDetail implements SuperEntity {
    ...
    public BorrowDetail(String BODeId, String regId, String bookID, String ISBN, String language, String issueDate, String dueToReturn, String returnDate, String expiringDate, double fine) {
